...
client.on("interactionCreate", async (interaction) => {
  ...
  if (!suggestion) return interaction.reply({ embeds: [new EmbedBuilder().setColor("#ff5e5e").setDescription(`❌ This [suggestion](${interaction.message.url}) was not found in the database.`)], ephemeral: true });
