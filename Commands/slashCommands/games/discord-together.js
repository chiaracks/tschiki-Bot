...
module.exports = {
	...
	description: "Play some cool games!",
		...
		switch(choices) {
            case "youtube": {
                ...
                if(!invc) return interaction.reply({
                    content: "> :exclamation: Please connect to a vc to generate your Youtube-together link"
                })
                ...
                client.discordTogether.createTogetherCode(interaction.member.voice.channelId, 'youtube').then(async invite => {
                    interaction.reply({
                        content: `> :recycle: Press on the link to join the activity! ${invite.code}`
                    })
                })
            ...
            case "chess": {
                ...
                if(!invc) return interaction.reply({
                    content: "> :exclamation: Please connect to a vc to generate your chess-together link"
                })
            ...
            case "betrayal": {
                ...
                if(!invc) return interaction.reply({
                    content: "> :exclamation: Please connect to a vc to generate your betrayal-together link"
                })
            ...
            case "poker": {
                ...
                if(!invc) return interaction.reply({
                    content: "> :exclamation: Please connect to a vc to generate your poker-together link"
                })
            ...
            case "fish": {
                ...
                if(!invc) return interaction.reply({
                    content: "> :exclamation: Please connect to a vc to generate your fishing-together link"
                })
            ...
            case "lettertile": {
                ...
                if(!invc) return interaction.reply({
                    content: "> :exclamation: Please connect to a vc to generate your lettertile-together link"
                })
            ...
            case "word_snack": {
                ...
                if(!invc) return interaction.reply({
                    content: "> :exclamation: Please connect to a vc to generate your word_snack-together link"
                })
            ...
            case "doodle_crew": {
                ...
                if(!invc) return interaction.reply({
                    content: "> :exclamation: Please connect to a vc to generate your doodle_crew-together link"
                })
            ...
            case "spell_cast": {
                ...
                if(!invc) return interaction.reply({
                    content: "> :exclamation: Please connect to a vc to generate your spellcast-together link"
                })
            ...
            case "awkword": {
                ...
                if(!invc) return interaction.reply({
                    content: "> :exclamation: Please connect to a vc to generate your awkword-together link"
                })
            ...
            case "puttparty": {
                ...
                if(!invc) return interaction.reply({
                    content: "> :exclamation: Please connect to a vc to generate your puttparty-together link"
                })
